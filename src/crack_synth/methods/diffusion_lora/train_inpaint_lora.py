...
def build_parser() -> ArgumentParser:
    ...
    parser.add_argument("--learning_rate", "--learning-rate", dest="learning_rate", type=float, default=8e-5)
    ...
    parser.add_argument("--max_train_steps", "--max-train-steps", dest="max_train_steps", type=int, default=1600)
    ...
    parser.add_argument("--mask_loss_weight", "--mask-loss-weight", dest="mask_loss_weight", type=float, default=15.0)
